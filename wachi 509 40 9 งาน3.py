A, B, C, D, E, F, G, H, I, J, K, L, M, N, O = 15.15, 10, 11.50, 21.50, 15.75, 29.50, 19, 6.50, 10, 120.25, 150, 150, 105, 20, 10.25
print('ฉันออกไปโดยพกเงินไป 1000 บาทเพื่อไปซื้อของ 15 รายการดังนี้')
print('น้ำเปล่า : 15.15 บาท')
print('น้ำแข็ง : 10.00 บาท')
print('ชาไทย : 11.50 บาท')
...
while True:
    Money = input("คุณจ่ายเงินจำนวน (ตอนนี้มีแบงก์ 1000 บาท 1 ใบ และไม่ต้องพิมพ์หน่วยบาทหรือเว้นวรรค): ")
    try:
        Money = float(Money)
        if Money == 1000.0:
            เงินทอน = Money - เงินที่ต้องจ่าย
            print('<<<<<คุณได้รับเงินทอนทั้งสิ้น:', round(เงินทอน, 2), 'บาท',">>>>>")
            print('<<<<<สรุปคุณใช้จ่ายไปทั้งสิ้น:', เงินที่ต้องจ่าย, 'บาท',">>>>>")
            break
        else:
            print('>>>> คุณไม่สามารถจ่ายด้วยจำนวนเงินอื่นๆ ได้นอกจาก 1000 บาท เพราะตอนนี้คุณมีแค่แบงก์พัน 1 ใบเท่านั้น')
    except ValueError:
